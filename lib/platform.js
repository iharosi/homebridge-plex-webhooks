  ...
  _processPayload(payload) {
    ...
    sensors.filter(sensor => {
      ...
      if (context && context.setState) {
        ...
        this.log.error(new Error('context.setState is missing'));
        this.log.warn(
          'One of your sensor did not register properly, ' +
          'please restart your homebridge server!'
        );
        this.log.warn(
          'In case you\'re still having this error, please raise a ticket: ' +
          'https://github.com/iharosi/homebridge-plex-webhooks/issues'
        );
      }
    });
  }
